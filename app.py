...
MOF_tool_about = textwrap.wrap(' These tools aim to provide a reproducible and consistent data visualisation platform '
                               ...
                               width=50)
twoD_threeD_about = textwrap.wrap(' The 2D Animated MOF Explorer and 3D Animated MOF Explorer provides a 4-Dimensional '
                                  'and 5-Dimensional variable environment respectively to explore specific structures '
...
app.layout = html.Div([
    html.Div([
        ...
        html.H1("Metal-Organic Framework Data Visusaliation Tools",
                style={'display': 'inline-block', 'padding-left': '10%', 'fontSize': 32,
        ...
        dcc.Tabs([
            dcc.Tab(label='About', style=tab_style, selected_style=tab_selected_style,
                    children=[html.Div([html.H2(" What are AAML's MOF Data Visualisation tools?",
                                        ...
                                        # ADD LINK
                                        html.Div([html.Plaintext([' Click ', html.A('here', href='https://github.com/aaml-analytics/mof-explorer')],
